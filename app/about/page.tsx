...
function SectionLabel({ children, light }: { children: React.ReactNode; light?: boolean }) {
  return (
    <div className="flex items-center gap-3 mb-4">
      <div className={`w-6 h-px ${light ? 'bg-[#C9A96E]/70' : 'bg-[#C9A96E]'}`} />
...
export default function AboutPage() {
  ...
  const stats = [
    { icon: FiUsers, value: '+2k', title: 'Membres', description: 'Utilisateurs actifs' },
    { icon: FiGlobe, value: '+15', title: 'Secteurs', description: 'Communautés locales' },
    { icon: FiBriefcase, value: '+50', title: 'Entreprises', description: 'Annuaire économique' },
    { icon: FiCalendar, value: '24/7', title: 'Disponibilité', description: 'Accès permanent' },
  ];
  ...
  const pillars = [
    {
      ...
      description: 'Préservation de la mémoire collective et transmission de l\'héritage royal.',
      features: ['Histoire dynastique', 'Symboles royaux', 'Lieux sacrés', 'Récits ancestraux']
    },
    {
      icon: FiMusic,
      title: 'Culture & Identité',
      description: 'Valorisation des traditions, danses, rites et artisanat Bangang.',
      features: ['Danses traditionnelles', 'Cérémonies', 'Artisanat', 'Langue locale']
    },
    {
      icon: FiMapPin,
      title: 'Tourisme & Nature',
      description: 'Découverte des richesses naturelles et sites emblématiques.',
      features: ['Massif des Bamboutos', 'Chutes de Mekoup', 'Lacs sacrés', 'Grassfields']
    },
    {
      icon: FiUsers,
      title: 'Réseau Communautaire',
      description: 'Plateforme sociale locale pour les échanges et partage.',
      features: ['Actualités', 'Événements', 'Annonces', 'Chat secteur']
    },
    {
      icon: FiBriefcase,
      title: 'Économie Locale',
      description: 'Soutien à la visibilité des entreprises et artisans.',
      features: ['Commerce', 'Artisanat', 'Services', 'PME locales']
    },
    {
      icon: FiShield,
      title: 'Gouvernance Moderne',
      description: 'Accompagnement de la modernisation institutionnelle.',
      features: ['Infos officielles', 'Projets', 'Communication']
    },
  ];
  ...
  return (
    <main className="w-full overflow-x-hidden bg-[#F4F0E8] font-sans">
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-20 py-16 sm:py-20 text-center">
          <div className="max-w-4xl mx-auto">

            {/* Badge */}
            <div className="inline-flex items-center gap-2 mb-5 px-3 py-1.5 sm:px-4 sm:py-2 border border-[#C9A96E]/30 backdrop-blur-md bg-[#C9A96E]/10 rounded-full">
              <div className="w-1.5 h-1.5 rounded-full bg-[#C9A96E] animate-pulse" />
              <span className="font-sans text-[8px] sm:text-[10px] font-medium tracking-[0.25em] sm:tracking-[0.3em] uppercase text-[#C9A96E]/90">
                Qui sommes-nous ?
              </span>
            </div>

            {/* Titre — taille contrôlée sur mobile */}
            <h1 className="font-serif text-[36px] xs:text-[42px] sm:text-[56px] md:text-[72px] lg:text-[96px] font-bold text-[#F5EDD8] leading-[1.05] tracking-[-0.02em] mb-5">
              À propos de{' '}
            ...
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <span className="font-sans text-[8px] sm:text-[11px] tracking-[0.2em] sm:tracking-[0.25em] uppercase text-[#C9A96E]/60 text-center">
                Plateforme communautaire & culturelle
              </span>
              <div className="w-10 sm:w-16 h-px bg-[#C9A96E]/60" />
            </div>

            {/* Sous-titre — masqué sur très petit écran, allégé sur mobile */}
            <p className="font-serif text-[15px] sm:text-[20px] lg:text-[26px] italic text-[#F5EDD8]/80 leading-relaxed max-w-3xl mx-auto px-2">
      ...
      {/* ══════════════════════════════════════════════════════
          INTRODUCTION
      ══════════════════════════════════════════════════════ */}
      <section className="py-12 sm:py-20 lg:py-24 px-4 sm:px-8 lg:px-20 bg-[#F4F0E8]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">

            <div>
              <SectionLabel>Notre Mission</SectionLabel>
              <h2 className="font-serif text-[26px] sm:text-[36px] lg:text-[48px] font-bold text-[#1A1712] leading-tight tracking-[-0.02em] mb-4 sm:mb-6">
                Créer un <span className="text-[#C9A96E]">écosystème digital</span>{' '}
                au service du Royaume
              </h2>
              <p className="font-sans text-[13px] sm:text-[15px] text-[#1A1712]/60 leading-relaxed mb-4">
              ...
              <p className="font-sans text-[13px] sm:text-[15px] text-[#1A1712]/60 leading-relaxed mb-6 sm:mb-8">
                L'objectif est de créer un véritable écosystème digital du royaume, 
                capable de connecter les habitants, la diaspora, les visiteurs et les 
                autorités traditionnelles autour d'une même plateforme moderne.
              </p>
              <div className="flex items-center gap-3">
                <div className="w-8 sm:w-12 h-px bg-[#C9A96E]" />
                <span className="font-serif text-[15px] sm:text-lg italic text-[#1A1712]/70">
            ...
            <div className="relative mt-4 lg:mt-0">
              <div className="relative h-[220px] xs:h-[260px] sm:h-[360px] lg:h-[400px] rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl">
                <Image src="/bams.jpg" alt="BangangConnect Vision" fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
              </div>
              {/* Coins décoratifs — masqués sur mobile pour éviter débordement */}
              <div className="hidden sm:block absolute -bottom-6 -right-6 w-24 sm:w-32 h-24 sm:h-32 border-b-2 border-r-2 border-[#C9A96E]/40 rounded-br-2xl" />
              <div className="hidden sm:block absolute -top-6 -left-6 w-24 sm:w-32 h-24 sm:h-32 border-t-2 border-l-2 border-[#C9A96E]/40 rounded-tl-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ══════════════════════════════════════════════════════
          STATS
      ══════════════════════════════════════════════════════ */}
      <section className="py-10 sm:py-16 px-4 sm:px-8 lg:px-20 bg-[#EDE9DF]">
        <div className="max-w-7xl mx-auto">
          {/* Sur mobile : 2 colonnes compactes */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            {stats.map((stat, i) => (
              <div key={i} className="text-center p-4 sm:p-6 bg-white/50 backdrop-blur-sm rounded-xl border border-[#C9A96E]/10">
                <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-[#C9A96E]/10 flex items-center justify-center mx-auto mb-2 sm:mb-3">
                  <stat.icon className="w-4 h-4 sm:w-5 sm:h-5 text-[#C9A96E]" />
                </div>
                <div className="font-serif text-2xl sm:text-4xl font-bold text-[#1A1712] mb-0.5 sm:mb-1">{stat.value}</div>
                <div className="font-sans text-[11px] sm:text-sm font-semibold text-[#1A1712] mb-0.5 sm:mb-1">{stat.title}</div>
                {/* Description masquée sur mobile, visible à partir de sm */}
                <div className="hidden sm:block font-sans text-xs text-[#1A1712]/50">{stat.description}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-8 lg:px-20 bg-[#F4F0E8]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h2 className="font-serif text-[26px] sm:text-[36px] lg:text-[52px] font-bold text-[#1A1712] leading-tight">
              Une plateforme <span className="text-[#C9A96E]">multidimensionnelle</span>
            </h2>
          </div>

          {/* Sur mobile : 2 colonnes, sur lg : 4 colonnes */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-8 sm:mb-12">
            {[
              ...
              <div key={i} className="flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-white/30 rounded-xl border border-[#C9A96E]/10 text-center sm:text-left">
                <div className="w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 rounded-full bg-[#C9A96E]/10 flex items-center justify-center">
                  <item.icon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#C9A96E]" />
                </div>
                <span className="font-sans text-[11px] sm:text-sm font-medium text-[#1A1712] leading-tight">{item.title}</span>
              </div>
            ))}
          </div>

          <p className="font-serif text-center text-[14px] sm:text-xl italic text-[#1A1712]/60 max-w-4xl mx-auto leading-relaxed px-2">
            « BangangConnect est la plateforme numérique officielle de promotion culturelle, 
            touristique, économique et communautaire du royaume Bangang. »
          </p>
        </div>
      </section>
      ...
      {/* ══════════════════════════════════════════════════════
          PILIERS (6 axes)
      ══════════════════════════════════════════════════════ */}
      <section className="bg-[#0D0B07] py-12 sm:py-20 lg:py-28 px-4 sm:px-8 lg:px-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h2 className="font-serif text-[26px] sm:text-[36px] lg:text-[52px] font-bold text-[#F5EDD8] leading-tight">
              Les piliers de <em className="italic text-[#C9A96E]">BangangConnect</em>
            </h2>
            <p className="font-sans text-[12px] sm:text-[15px] text-[#F5EDD8]/45 max-w-3xl mx-auto mt-3 px-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5 lg:gap-6">
            {pillars.map((pillar, i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-[#111009] p-4 sm:p-6 sm:p-8 rounded-xl sm:rounded-2xl border border-[#C9A96E]/10 hover:border-[#C9A96E]/30 transition-all duration-300 group"
                >
                  <div className="flex items-start gap-3 sm:block">
                    {/* Icône inline sur mobile, block sur desktop */}
                    <div className="w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0 rounded-full bg-[#C9A96E]/10 flex items-center justify-center sm:mb-4 group-hover:bg-[#C9A96E]/20 transition-colors">
                      <Icon className="w-4 h-4 sm:w-5 sm:h-5 text-[#C9A96E]" />
                    </div>
                    <div className="flex-1">
                      <h3 className="font-serif text-[16px] sm:text-xl font-semibold text-[#F5EDD8] mb-1 sm:mb-3 leading-tight">
                        {pillar.title}
                      </h3>
                      <p className="font-sans text-[12px] sm:text-[13px] text-[#F5EDD8]/45 leading-relaxed mb-3">
                        {pillar.description}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-1 sm:mt-0">
                    {pillar.features.map((feature, idx) => (
                      <span key={idx} className="text-[9px] sm:text-[10px] px-2 py-1 bg-[#C9A96E]/10 text-[#C9A96E]/70 rounded-full">
                        {feature}
                      </span>
                    ))}
                  </div>
      ...
      {/* ══════════════════════════════════════════════════════
          DIASPORA
      ══════════════════════════════════════════════════════ */}
      <section className="py-12 sm:py-20 px-4 sm:px-8 lg:px-20 bg-[#F4F0E8] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">

            {/* Image en premier sur mobile */}
            <div className="relative order-1 lg:order-2">
              <div className="relative h-[200px] xs:h-[240px] sm:h-[340px] lg:h-[400px] rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl">
                <Image src="/bams3.jpg" alt="Diaspora Bangang" fill className="object-cover brightness-90" />
              </div>
              <div className="hidden sm:block absolute -bottom-6 -left-6 w-24 sm:w-32 h-24 sm:h-32 border-b-2 border-l-2 border-[#C9A96E]/40 rounded-bl-2xl" />
              <div className="hidden sm:block absolute -top-6 -right-6 w-24 sm:w-32 h-24 sm:h-32 border-t-2 border-r-2 border-[#C9A96E]/40 rounded-tr-2xl" />
            </div>

            <div className="order-2 lg:order-1">
              <SectionLabel>Diaspora Bangang</SectionLabel>
              <h2 className="font-serif text-[26px] sm:text-[36px] lg:text-[48px] font-bold text-[#1A1712] leading-tight tracking-[-0.02em] mb-4 sm:mb-6">
                Rapprocher la <span className="text-[#C9A96E]">communauté</span>{' '}
                où qu'elle se trouve
              </h2>
              <p className="font-sans text-[13px] sm:text-[15px] text-[#1A1712]/60 leading-relaxed mb-5 sm:mb-6">
                Un axe important de BangangConnect est de rapprocher les habitants du royaume,
                les ressortissants vivant dans d'autres villes et la diaspora internationale.
              </p>
              <div className="space-y-3">
                {['Investissements communautaires', 'Projets de développement', 'Transmission culturelle', 'Initiatives collectives'].map((item, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <div className="w-1.5 h-1.5 flex-shrink-0 rounded-full bg-[#C9A96E]" />
                    <span className="font-sans text-[13px] sm:text-[14px] text-[#1A1712]/70">{item}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* ══════════════════════════════════════════════════════
          VALEURS
      ══════════════════════════════════════════════════════ */}
      <section className="bg-[#1A1712] py-12 sm:py-20 lg:py-24 px-4 sm:px-8 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <SectionLabel light>Nos Valeurs</SectionLabel>
            <h2 className="font-serif text-[26px] sm:text-[36px] lg:text-[48px] font-bold text-[#F5EDD8] leading-tight">
              Ce qui nous <em className="italic text-[#C9A96E]">anime</em>
            </h2>
          </div>

          {/* Mobile : 2 col compactes / lg : 3 col */}
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5 lg:gap-6">
            {values.map((value, i) => {
              const Icon = value.icon;
              return (
                <div key={i} className="bg-[#0D0B07] p-4 sm:p-6 rounded-xl border border-[#C9A96E]/10 text-center hover:border-[#C9A96E]/30 transition-all duration-300">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-[#C9A96E]/10 flex items-center justify-center mx-auto mb-3">
                    <Icon className="w-4 h-4 sm:w-6 sm:h-6 text-[#C9A96E]" />
                  </div>
                  <h3 className="font-serif text-[15px] sm:text-lg font-semibold text-[#F5EDD8] mb-1 sm:mb-2">{value.title}</h3>
                  {/* Description raccourcie/masquée sur très petit écran */}
                  <p className="font-sans text-[11px] sm:text-[13px] text-[#F5EDD8]/45 leading-relaxed hidden xs:block">{value.description}</p>
                </div>
              );
            })}
          </div>
      ...
      {/* ══════════════════════════════════════════════════════
          CTA FINAL
      ══════════════════════════════════════════════════════ */}
      <section className="relative min-h-[380px] sm:min-h-[400px] flex items-center justify-center text-center py-16 sm:py-20 px-4 sm:px-8 lg:px-20 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/roibangang.jpg" alt="" fill className="object-cover brightness-[0.25] saturate-70" aria-hidden />
        </div>
        <div className="absolute inset-0 bg-black/60" />

        <div className="relative z-10 max-w-4xl mx-auto w-full">
          <div className="font-sans text-[8px] sm:text-[9px] tracking-[0.3em] sm:tracking-[0.35em] uppercase text-[#C9A96E]/60 mb-4 sm:mb-6">
            ◈ &nbsp; Rejoignez l'aventure &nbsp; ◈
          </div>

          <h2 className="font-serif text-[26px] sm:text-[36px] lg:text-[56px] font-bold text-[#F5EDD8] leading-tight mb-4 sm:mb-6">
            Ensemble, construisons le numérique{' '}
            <em className="italic text-[#C9A96E]">au service de notre identité</em>
          </h2>

          <p className="font-sans text-[12px] sm:text-[15px] text-[#F5EDD8]/50 leading-relaxed mb-8 sm:mb-10 max-w-2xl mx-auto px-2">
            Rejoignez la communauté BangangConnect et participez à la valorisation 
            du royaume Bangang.
          </p>

          {/* Boutons full-width sur mobile, auto sur sm+ */}
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <Link
              href="/register"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-7 py-3.5 sm:px-8 sm:py-4 bg-[#C9A96E] text-[#0D0B07] font-sans text-[11px] sm:text-[12px] font-semibold tracking-[0.12em] uppercase rounded-full transition-all duration-300 hover:bg-[#DFC08A] active:scale-[0.98]"
            >
              Créer un compte <span>→</span>
            </Link>
            <Link
              href="/contact"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-7 py-3.5 sm:px-8 sm:py-4 border border-[#C9A96E]/40 text-[#F5EDD8] font-sans text-[11px] sm:text-[12px] font-normal tracking-[0.12em] uppercase rounded-full transition-all duration-300 hover:border-[#C9A96E]/80 active:scale-[0.98]"
            >
